    ...
    <div className="max-w-md mx-auto py-20 px-8">
      <div className="border border-muted-sage/30 bg-paper-cream/40 p-8 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-xs font-mono uppercase tracking-wider text-muted-sage block mb-1.5">
              Full Name
            </label>
            <input
              type="text"
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full border border-ink-navy text-ink-navy py-2 mt-4 text-sm font-semibold hover:bg-ink-navy hover:text-paper-cream transition-colors duration-150 cursor-pointer disabled:opacity-50"
          >
            {submitting ? "RECORDING..." : "CREATE ACCOUNT"}
          </button>
        </form>
